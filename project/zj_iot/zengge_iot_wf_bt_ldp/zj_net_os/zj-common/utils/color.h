...
*@ Return         :
*******************************************************************************/
int convertCCTtoRGB(unsigned int tmpKelvin,unsigned char* r,unsigned char* g,unsigned char* b);

/*  
 * Converts HS,V values to RGB storing in given addresses
 *
 * @param hs         Value of Hue & Saturation : 9bits H + 7bits S	
 * @param v         Value of Value 0-100
 * @param r         Address of Red
 * @param g         Adderss of Green
 * @param b         Address of Blue
 *
 * @return void
 */
void convertHS_VtoRGB(uint16_t hs,uint8_t v,unsigned char *r, unsigned char *g, unsigned char *b);
