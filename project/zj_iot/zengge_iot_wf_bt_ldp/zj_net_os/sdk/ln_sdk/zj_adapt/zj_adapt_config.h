...
#define PORT_CONFIG_LIGHT_FUNC_PRIO           (5) // (3)  
#define PORT_CONFIG_LIGHT_REMOTE_TASK_PRIO    (4) // (2)  
#define PORT_CONFIG_TCP_SERVER_TASK_PRIO      (12)// (3)  
#define PORT_CONFIG_TCP_CLIENT_TASK_PRIO      (13)// (4) 
#define PORT_CONFIG_TCP_CLIENT_SEND_TASK_PRIO (10)// (5) 
#define PORT_CONFIG_UDP_SERVER_TASK_PRIO      (9)// (5) 
#define PORT_CONFIG_TIMER_CLOCK_TASK_PRIO     (2) // (2) 
#define PORT_CONFIG_AUTO_REPORT_TASK_PRIO     (3) // (2) 
#define PORT_CONFIG_FOTA_TASK_PRIO            (10)// (3) 
#define PORT_CONFIG_ZG_EVENT_LOOP_TASK_PRIO   (11)// (4) 
#define PORT_CONFIG_ZG_WATCHDOG_TASK_PRIO     (1) // (1) 
#define PORT_CONFIG_KV_TASK_PRIO              (1) // (1)  
#define PORT_CONFIG_MIC_TASK_PRIO             (5) // (3)  
#define PORT_CONFIG_BT_REMOTE_EVENT_TASK_PRIO (6) // (4)  
#define PORT_CONFIG_KEY_TASK_PRIO             (15)// (5) 
#define PORT_CONFIG_BLE_TASK_PRIO             (15)// (5) 
#define ZG_DATA_TASK_PRIO                     (7) // (5) 
#define PORT_CONFIG_NET_DIAGNOSIS_TASK_PRIO   (15)// (4) 
