#ifndef VERSION_48_CONFIG_H
#define VERSION_48_CONFIG_H

#define PROTOCOL_VERSION                  4


#define CUSTOMER_DIFF_IR_KEY

#if defined(CUSTOMER_DIFF_IR_KEY)
...
#define APPCONFIG_DEFF_MODE               DEF_FACMODE_OTHER_MODE  /* 第一次烧录出厂模式 */
#define APPCONFIG_REST_MODE               DEF_FACMODE_RGBW_JUMP  /* 重置模式 */
#define APPCONFIG_DEF_PWRON_CFG           PWR_ON_STATUS_MEMORY   /* 默认出厂通电反应设置 */
#define APPCONFIG_SUPPORT_COLOR_RGB                              
#define APPCONFIG_SUPPORT_COLOR_WARM
#define APPCONFIG_SUPPORT_REMOTE_B9                             
#define APPCONFIG_DEF_WIRING_TYPE         WIRING_TYPE_RGBW       /* 默认接线类型设置 */     
#define APPCONFIG_RESTORE_COUNT           6                      /* 上电多少次恢复出厂设置 */
#define APPCONFIG_ENABLE_CFG_RGBWC_BOTH   1                      /* 允许rgb和cct同时亮 */
