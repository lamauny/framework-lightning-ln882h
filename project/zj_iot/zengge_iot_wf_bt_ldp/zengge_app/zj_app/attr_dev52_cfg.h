#ifndef VERSION_52CONFIG_H
#define VERSION_52CONFIG_H

#define PROTOCOL_VERSION                  4                       /* 协议版本号         */

#define VERSION_TYPE                     "SL"                    /* 固件后缀id         */
#define APPCONFIG_PWM_DEPTH              6000 

                             
#define APPCONFIG_DEFF_MODE               DEF_FACMODE_CCT_TEST    /* 第一次烧录出厂模式 */
#define APPCONFIG_REST_MODE               DEF_RESET_CCT_AGING     /* 重置模式 */
#define APPCONFIG_SUPPORT_COLOR_CCT   
